    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
       	    <li><a href="gallery.html"><i class="fa fa-circle-o"></i> 갤러리</a></li>
            <li class="active"><a href="chosen.html"><i class="fa fa-circle-o"></i> 조선닷컴</a></li>
