...
<title>AdminLTE 2 | Gallery</title>
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu" data-widget="tree">
					...
					<li class="treeview active"><a href="#"> <i
						...
						<ul class="treeview-menu">
							<li class="active"><a href="gallery.html"><i
									class="fa fa-circle-o"></i> 갤러리</a></li>
									<li><a href="chosen.html"><i class="fa fa-circle-o"></i> 조선닷컴</a></li>
							...
							<li><a href="500.html"><i class="fa fa-circle-o"></i>
									500 Error</a></li>
							<li><a href="blank.html"><i class="fa fa-circle-o"></i>
									Blank Page</a></li>
