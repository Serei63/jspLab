...
<div class="login-box">
  <div class="login-logo">
    <a href="<%= request.getContextPath() %>/view/main/index.jsp"><b>Admin</b>LTE</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <a href="<%= request.getContextPath() %>/view/login/register.jsp" class="text-center">Register a new membership</a>
