...
<link rel="stylesheet" type="text/css" href="<%= request.getContextPath() %>/resources/js/style.css" />
    ...
    <div id="visual">
			<div id="mySwipe" class='swipe'>
				<ul class="touch_banner swipe-wrap">
					<!-- 배너 목록 -->
					<li><a href="#"><img src="<%= request.getContextPath() %>/resources/images/visual_img_1.jpg" alt="" /></a></li>
					<li><a href="#"><img src="<%= request.getContextPath() %>/resources/images/visual_img_2.jpg" alt="" /></a></li>
					<li><a href="#"><img src="<%= request.getContextPath() %>/resources/images/visual_img_3.jpg" alt="" /></a></li>
				</ul>
			</div>
			...
			<p class="touch_right_btn">
				<!-- 다음 버튼 -->
				<a href="#"> <img src="<%= request.getContextPath() %>/resources/images/visual_btn_right.png" alt="다음 배너" />
				</a>
			</p>
		</div>
...
<!-- 터치 슬라이드 플러그인 연동 -->
<script type="text/javascript" src="<%= request.getContextPath() %>/resources/js/jquery.bxslider.min.js"></script>
<script type="text/javascript">
